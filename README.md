...
> A collection of landing-page projects, including an AI agency website and Lightnation interface. Each project is organised as a separate workspace directory.
...
```bash
git clone https://github.com/DIPESH-THADA/landing-page.git
cd landing-page
